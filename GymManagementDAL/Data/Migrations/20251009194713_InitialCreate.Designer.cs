...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20251009194713_InitialCreate")]
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("PlanDurationsDaysCheck", "DurationDays Between 1 and 365");
                        });
                });
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("SessionEndDateChec", "EndDate > StartDate");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.MemberSession", b =>
                {
                    ...
                    b.HasOne("GymManagementDAL.Entities.Session", "Sessions")
                        .WithMany("MemberSessions")
